...
\- The smoke scope should verify presence and identity, not deep interaction flows
...
\- Which offer categories are business-critical and should later be upgraded from visibility checks to click/navigation checks?
...
Offer category Customer Experience is visible



\*\*Requirement\*\*  

A desktop user shall be able to see the Customer Experience offer category on the Erbjudanden page.
...
\- Then `Customer Experience` is visible
...
\- And visible form fields are present
...
\- And an email input or signup control is visible
